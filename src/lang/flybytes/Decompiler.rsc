...
// the compiler only puts DUP if there were no side-effects, so we assume here 
// that all DUPS were generated by a compiler. Of course if somebody generated bytecode
// "manually", this assumption is broken and we might now have copied an effect:  
